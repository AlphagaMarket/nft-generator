# Alphaga NFT Generator 🔥

Create generative nft by using the canvas api and node js. Before you use the generation engine, make sure you have node.js(v14.0.0) installed.
...
const layerConfigurations = [
  ...
  {
    // Creates an additional 100 nfts
...
```json
{
  ...
  "image": "https://arweave.net/your_data_tx_id/1.png",
  "attributes": [
